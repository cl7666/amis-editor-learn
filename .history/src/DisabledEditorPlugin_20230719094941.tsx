...
import { SubRendererInfo, BasicSubRenderInfo } from 'amis-editor';
/**
 * 用于隐藏一些不需要的Editor组件
...
export class ManagerEditorPlugin extends BasePlugin {
  order = 9999;
  buildSubRenderers(renderers: Array<SubRendererInfo>): BasicSubRenderInfo | Array<BasicSubRenderInfo> | void  ={
    // 更新NPM自定义组件排序和分类
...
registerEditorPlugin(ManagerEditorPlugin as any);
